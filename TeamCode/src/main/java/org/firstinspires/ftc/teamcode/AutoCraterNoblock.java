...
public class AutoCraterNoblock extends LinearOpMode {
    ...
    AutoCommand cmd[] = {
            ...
            new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.FORWARD, 13, 0.8, 0,0, 2000),
            new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.PIVOTLEFT, 270, 0.8,0,0,2000),
            new AutoCommand(AutonomousStates.AutoStates.MOVE, Drive.MoveType.FORWARD, 52, 0.8, 0,0, 5000),
